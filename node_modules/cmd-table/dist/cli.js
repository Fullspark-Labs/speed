...
var Column = class {
  constructor(options2 = {}) {
    ...
    this.key = options2.key || this.name;
    this.width = options2.width;
    if (options2.minWidth !== void 0) this.minWidth = options2.minWidth;
    if (options2.maxWidth !== void 0) this.maxWidth = options2.maxWidth;
    if (options2.align) this.align = options2.align;
    if (options2.vAlign) this.vAlign = options2.vAlign;
    if (options2.paddingLeft !== void 0) this.paddingLeft = options2.paddingLeft;
    if (options2.paddingRight !== void 0) this.paddingRight = options2.paddingRight;
    if (options2.truncate !== void 0) this.truncate = options2.truncate;
    if (options2.wrapWord !== void 0) this.wrapWord = options2.wrapWord;
    if (options2.priority !== void 0) this.priority = options2.priority;
    if (options2.hidden !== void 0) this.hidden = options2.hidden;
    if (options2.color !== void 0) this.color = options2.color;
    if (options2.formatter !== void 0) this.formatter = options2.formatter;
  }
};
...
var CsvRenderer = class {
  constructor(options2 = {}) {
    ...
    this.quote = options2.quote || '"';
    this.includeHeader = options2.includeHeader !== false;
  }
  render(table) {
...
var Table = class _Table {
  constructor(options2 = {}) {
    ...
    this.zebra = false;
    this.headerGroups = [];
    this.theme = options2.theme || THEME_Rounded;
    this.compact = Boolean(options2.compact);
    this.terminalWidth = options2.terminalWidth;
    this.responsiveMode = options2.responsiveMode || "none";
    this.zebra = Boolean(options2.zebra);
    this.headerGroups = options2.headerGroups || [];
    this.headerColor = options2.headerColor || "magenta";
    this.rowColor = options2.rowColor;
    this.drawHorizontalLine = options2.drawHorizontalLine;
    if (options2.columns) {
      options2.columns.forEach((col) => this.addColumn(col));
    }
  }
  addColumn(options2) {
    const colOptions = typeof options2 === "string" ? { name: options2, key: options2 } : options2;
  ...
  export(format, options2 = {}) {
    switch (format) {
      case "csv":
        return new CsvRenderer(options2).render(this);
      case "json":
  ...
  static fromVertical(record, options2 = {}) {
  ...
  static fromCross(rowHeader, columnHeaders, rows, options2 = {}) {
    const table = new _Table({
      ...options2,
      columns: [
   ...
   */
  static compare(oldData, newData, options2 = {}) {
    const { primaryKey, showUnchanged = true, ...tableOpts } = options2;
...
var CsvTable = class {
   ...
   */
  static from(csvString, options2 = {}) {
    const { hasHeader = true, delimiter = "," } = options2;
   ...
   */
  static toCsv(table, options2) {
    return table.export("csv", options2);
  }
};
...
var InteractiveTable = class {
  constructor(table, options2 = {}) {
    ...
    this.table = table;
    this.pageSize = options2.pageSize || 10;
    this.onSelect = options2.onSelect;
    this.onExit = options2.onExit;
